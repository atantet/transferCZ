...
*      PARAMETER (nx = 29,ny = 30,na = ny,nf = 7,nr=ny,maxstep=75000)
      PARAMETER (nx = 29,ny = 30,na = ny,nf = 7,nr=ny,maxstep=42048)
...
*      PARAMETER (dstep=0.175) 	 
      ...
      real(kind=8) F0_t(nx+1,ny+1)
      real(kind=8) F0_t_dx(nx+1,ny+1)
      real(kind=8) F0_t_dy(nx+1,ny+1)
      real pi,par(31)
      real dpar(23)
      COMMON /CONST/ par,dpar,pi,icp1,sw_A,sw_flux,seed
